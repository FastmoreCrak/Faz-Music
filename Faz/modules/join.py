...
from Faz import app, ASSUSERNAME
from Faz.utils.decorators import sudo_users_only, errors
from Faz.utils.administrator import adminsOnly
from Faz.utils.filters import command
from Faz.tgcalls import client as USER


@app.on_message(
    command(["userbotjoin", "Fazjoin", "oj"]) & ~filters.private & ~filters.bot
)
@errors
...
@USER.on_message(filters.group & command(["userbotleave", "Fazleave", "Fazleft"]))
