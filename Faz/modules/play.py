...
from Faz.tgcalls import calls, queues
from Faz.tgcalls.calls import client as ASS_ACC
from Faz.database.queue import (
    get_active_chats,
    is_active_chat,
    add_active_chat,
    remove_active_chat,
...
from Faz import app
import Faz.tgcalls
from Faz.tgcalls import youtube
from Faz.config import (
    DURATION_LIMIT,
    que,
    SUDO_USERS,
    BOT_ID,
...
from Faz.utils.filters import command
from Faz.utils.decorators import errors, sudo_users_only
from Faz.utils.administrator import adminsOnly
from Faz.utils.errors import DurationLimitError
from Faz.utils.gets import get_url, get_file_name
from Faz.modules.admins import member_permissions
...
async def play(_, message: Message):
    ...
    if audio:
        ...
        title = audio.title
        thumb_name = "https://telegra.ph/file/6a54c4f936636b27d0f0e.png"
        ...
        file_path = await Faz.tgcalls.convert(
